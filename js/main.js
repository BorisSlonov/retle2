...
var swiperHouses = new Swiper('.swiper-container-houses', {
  // Optional parameters
  autoHeight: true,
  spaceBetween: 10,
  effect: 'coverflow',
...
$(document).ready(function () {
  ...
  function f_acc() {
    ...
    $('#accordeon .acc-body').not($(this).next()).slideUp(500); // открываем или скрываем блок под заголовком, по которому кликнули
